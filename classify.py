...
ROLE_MAP: dict[str, list[str]] = {
    ...
    "ai_engineer":        ["ai engineer", "artificial intelligence engineer", "llm engineer", "genai", "gen ai"],
    "data_scientist":     ["data scientist", "applied scientist", "quantitative analyst", "quant researcher"],
    "data_analyst":       ["data analyst", "business analyst", "analytics analyst", "bi analyst", "business intelligence"],
    "data_engineer":      ["data engineer", "etl engineer", "analytics engineer", "data platform", "data infrastructure"],
    "research_scientist": ["research scientist", "research engineer", "nlp researcher", "cv researcher", "applied researcher"],
}
